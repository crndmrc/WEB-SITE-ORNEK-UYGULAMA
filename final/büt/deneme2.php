...
<div class="container">
<h1> <b>MÜZİK RUHUN GIDASIDIR</b></h1>
 <hr>
          <p>
            <?php
              echo "Bu sayfanın amacı müzik paylaşım/öneri ve haber sitesidir.<br>\n";
              printf("İnsani yaşamın az çok her alanına nüfuz etmiş olmasına rağmen Steven Pinker (1997)
...
üzerine düşünmek için son derece verimlidir.<br>\n"); 
            ?>
          </p></div>
  ...
  <main role="main" class="container">
      <div class="row">
       ...
       include('connection.php');
        ...
        $query=mysqli_query($conn,"select * from haberler limit $page1,5 ");
         while($row=mysqli_fetch_array($query)){
          ?>
          <div class="blog-post">
            <h4 class="blog"> <a href="deneme.php?single=<?php echo $row['id'];?>"><?php echo $row['baslik']; ?> </a></h4>
            <p class="blog-post-meta"><?php echo $row['gun']; ?> <a href="#"><?php echo $row['admin'];?></a></p>

            <p><img class="img img-thumbnail"  src="büt/<?php echo $row['kucukresim'];?>"  width="400" height="200" > </p>
            <hr>
            
            <blockquote>
              <?php echo substr($row['aciklama'],0,300 ) ;?>
               <a href="deneme.php?single=<?php echo $row['id'];?> " class="btn btn-dark btn-sm">Daha fazla gör</a>
            </blockquote>
       ...
       $a=$count/5;
        ...
        for ($b=1; $b <=$a ; $b++) { 
         ...
         <li class="page-item"><a class="page-link" href="deneme.php?page=<?php echo $b;?>"><?php echo $b; ?></a></li>
       ...
       ?>
        ...
        <aside class="col-md-4 blog-sidebar">
          <div class="p-3 mb-3 bg-light rounded">
            <h4 class="font-italic">Hakkında</h4>
            <p class="mb-0">Bu site web programlama büt ödevidir.</p>
          </div>

           <div class="p-3">
            <h4 class="font-italic">Kategoriler</h4>
            <hr>
            <ol class="list-unstyled mb-0">
               ...
               ?>
              <li><a href="akıs.php?single=<?php echo$row['kategori_adi'];  ?>"><?php echo $row['kategori_adi']; ?></a></li>
              <?php } ?>
            </ol>
          </div></aside>
