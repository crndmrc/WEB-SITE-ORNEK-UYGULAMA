...
<html lang="en">
  <head>
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      ...
      <a href="deneme2.php" title="TEMPOS" alt="site adi"><img src="logo2.png" width= "145' height= "145'></a>
      </div>
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
      <a class="dropdown-item" href="paylasimyap.php">Paylaşım Yap</a>
      <a class="dropdown-item" href="duzenlevesil.php">Düzenle/Sil</a>
